...
namespace Netvision.Backend.Providers
{
    ...
    public class Provider<T>
    {
        ...
        public Provider(EntryType type)
        {
            ...
            var items = db.SQLQuery<ulong>(string.Format("SELECT * FROM {0}", table));
        ...
        public void HeartBeat()
        {
            foreach (var item in members.Values)
                if (HasMethod(item.GetType(), "HeartBeat"))
                    item.GetType().GetMethod("HeartBeat")
                        .Invoke(typeof(T), null);
        }
        ...
        /// <param name="name">Name.</param>
        bool HasMethod(Type obj, string name)
        {
            return obj.GetMethod(name) != null;
        }
        ...
        /// <param name="obj">Object.</param>
        /// <param name="name">Name.</param>
        public bool HasProperty(Type obj, string name)
        {
        ...
        /// <param name="obj">Object.</param>
        /// <param name="name">Name.</param>
        public bool HasField(Type obj, string name)
        {
